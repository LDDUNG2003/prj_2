...
for (var i = 0 ; i < length.document.getElementsByClassName ("navBar__list-item"); i++){
    document.getElementsByClassName ("navBar__list-item")[0].addEventListener("click", clickLink());
}
