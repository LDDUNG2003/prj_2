...
function Home(){
    return (
        ...
        <div className="content--list-image">
          <img className="content--image" src="./public/img/banner.png" alt />
        </div>
      ...
      <div className="content__focut">
        <ul className="focut--list">
          <li className="focut--item">
            <img src="./public/img/product/icon-phong-khach.png" alt className="focut--img" />
            <h6 className="focut--text">Phòng khách</h6>
          </li>
          <li className="focut--item">
            <img src="./public/img/product/icon-phong-ngu.png" alt className="focut--img" />
            <h6 className="focut--text">Phòng Ngủ</h6>
          </li>
          <li className="focut--item">
            <img src="./public/img/product/icon-phong-bep.png" alt className="focut--img" />
            <h6 className="focut--text">Phòng Bếp</h6>
          </li>
          <li className="focut--item">
            <img src="./public/img/product/icon-phong-tam.png" alt className="focut--img" />
            <h6 className="focut--text">Phòng Tắm</h6>
          </li>
          <li className="focut--item">
            <img src="./public/img/product/icon-tre-em.png" alt className="focut--img" />
            <h6 className="focut--text">Trẻ Em</h6>
          </li>
          <li className="focut--item">
            <img src="./public/img/product/icon-van-phong.png" alt className="focut--img" />
            <h6 className="focut--text">Văn Phòng</h6>
          </li>
          <li className="focut--item">
            <img src="./public/img/product/icon-cau-thang.png" alt className="focut--img" />
            <h6 className="focut--text">Cầu Thang</h6>
          </li>
          <li className="focut--item">
            <img src="./public/img/product/icon-do-trang-tri.png" alt className="focut--img" />
      ...
      <div className="about__us">
        <div className="about--background">
          <img src="./public/img/about/bg-about-us.jpg" alt />
        </div>
            ...
            <div className="about__content ">
              ...
              <div className="about--block ">
                <div className="about--content ">
                  <img src="./public/img/about/ve-chung-toi.jpg" alt=" " />
                </div>
                <div className="about--content ">
                  ...
                  <ul className="about--list">
                    <li className="about--item">
                      <img src="./public/img/about/ve-chung-toi-1.jpg" alt className="about--img" />
                    </li>
                    <li className="about--item">
                      <img src="./public/img/about/ve-chung-toi-2.jpg" alt className="about--img" />
                    </li>
                    <li className="about--item">
                      <img src="./public/img/about/ve-chung-toi-3.jpg" alt className="about--img" />
                    </li>
                    <li className="about--item">
                      <img src="./public/img/about/ve-chung-toi-4.jpg" alt className="about--img" />
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="choose__choose">
                <ul className="choose--list">
                  <li className="choose--item">
                    <img src="./public/img/about/chinh-sach.jpg" alt className="choose-image" />
                  ...
                  <li className="choose--item">
                    <img src="./public/img/about/san-pham.jpg" alt className="choose-image" />
                    <div className="choose-contain">
                  ...
                  <li className="choose--item">
                    <img src="./public/img/about/chat-luong.jpg" alt className="choose-image" />
                    <div className="choose-contain">
                  ...
                  <li className="choose--item">
                    <img src="./public/img/about/bao-hanh.jpg " alt className="choose-image" />
                    <div className="choose-contain">
      ...
      <div className="news">
        ...
        <div className="news--contain">
          <div className="news--contain--item mobile-display">
            <img className="impotant--grd" src="./public/img/news/tintuc-1.jpg" alt />
          ...
          <div className="news--contain--item">
            <ul className="news--list">
              <li className="news--list-item">
                <img src="./public/img/news/tintuc-1.png" alt />
        ...
        <div className="partner--contain">
          ...
          <ul className="partner--list">
            <li className="partner--item">
              <img src="./public/img/partner/marvella.png" alt />
            </li>
            <li className="partner--item">
              <img src="./public/img/partner/melissa.png" alt />
            </li>
            <li className="partner--item">
              <img src="./public/img/partner/muong-thanh.png" alt />
            </li>
            <li className="partner--item">
              <img src="./public/img/partner/sheraton.png" alt />
            </li>
            <li className="partner--item">
              <img src="./public/img/partner/sunrise-sapa.png" alt />
            </li>
            <li className="partner--item">
              <img src="./public/img/partner/the-coffee-house.png" alt />
            </li>
            <li className="partner--item">
              <img src="./public/img/partner/vinpearl.png" alt />
            </li>
          </ul>
        </div>
      </div>
      <div className="content--contact">
        ...
        <div className="contact--contain">
          <img src="./public/img/lienhe-bg.jpg" alt className="contact-bg" />
          <div className="contact-contain">
