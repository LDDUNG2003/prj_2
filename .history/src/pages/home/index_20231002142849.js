  ...
  document.title = 'Trang Chủ'
    return (
      ...
      <div className="banner--content">
        ...
        <button onClick={clickCall} className="banner--button">LIÊN HỆ NGAY</button>
      </div>
    </div>
          ...
          <ul className="news--list">
            <li className="news--list-item">
              ...
              <div className="news--item-contain">
                <h4 className="new--item-heading">trang trí phòng khách nhà mình thêm năng động</h4>
                <p className="news--item-container">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae sed qui et. Quidem ipsam obcaecati inventore totam unde neque voluptates nulla veritatis, illo dolores provident, </p>
              </div>
            </li>
            <li className="news--list-item">
              <img src="./img/news/tintuc-1.png" alt />
    ...
    <div className="content--contact">
      ...
      <div className="contact--contain">
        <img src="./img/contact-bg.jpg" alt className="contact-bg" />
      </div>
    </div>
    </>
    )
